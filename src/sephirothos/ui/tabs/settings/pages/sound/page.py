...
class SoundPage(QWidget):
    ...
    def _build_ui(self):
        ...
        self.title_label = QLabel("Sephiroth's Functional Sound Wave Utensil")
        self.title_label.setProperty(
            "textRole",
            TextRole.PAGE_TITLE.value
        )

        self.subtitle_label = QLabel("She jumped out the car and broke all of her bones. What the fuck!!!")
